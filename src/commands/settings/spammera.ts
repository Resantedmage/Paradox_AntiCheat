...
function spammerAHelp(player: Player, prefix: string, spammerABoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `§4[§6Usage§4]§f: spammera [options]`,
        `§4[§6Options§4]§f:`,
        `    -h, --help      Display this help message`,
        `    -s, --status    Display the current status of SpammerA module`,
        `    -e, --enable    Enable SpammerA module`,
        `    -d, --disable   Disable SpammerA module`,
        `§4[§6Description§4]§f: Toggles checks for messages sent while moving.`,
        `§4[§6Examples§4]§f:`,
        `    ${prefix}spammera --help`,
        `    ${prefix}spammera --status`,
        `    ${prefix}spammera --enable`,
        `    ${prefix}spammera --disable`,
    ]);
}
    ...
    if (args.length > 0) {
        ...
        switch (additionalArg) {
            ...
            case "--disable":
                ...
                break;
            default:
                sendMsgToPlayer(player, `§f§4[§6Paradox§4]§f Invalid argument. Use ${prefix}spammera --help for command usage.`);
                break;
        }
    } else {
