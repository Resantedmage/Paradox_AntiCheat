...
function auraCheckHelp(player: Player, prefix: string, antiKillAuraBoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `§4[§6Usage§4]§f: auracheck [options]`,
        `§4[§6Options§4]§f:`,
        `    -h, --help      Display this help message`,
        `    -s, --status    Display the current status of AntiKillAura module`,
        `    -e, --enable    Enable AntiKillAura module`,
        `    -d, --disable   Disable AntiKillAura module`,
