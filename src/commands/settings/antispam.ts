...
function antispamHelp(player: Player, prefix: string, antiSpamBoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `§4[§6Usage§4]§f: antispam [options]`,
        `§4[§6Options§4]§f:`,
        `    -h, --help      Display this help message`,
        `    -s, --status    Display the current status of AntiSpam module`,
        `    -e, --enable    Enable AntiSpam module`,
        `    -d, --disable   Disable AntiSpam module`,
        `§4[§6Description§4]§f: Checks for spamming in chat with a 2-second cooldown.`,
        `§4[§6Examples§4]§f:`,
