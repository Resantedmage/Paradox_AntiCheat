...
function antinukeraHelp(player: Player, prefix: string, antiNukerABoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `    -s, --status    Display the current status of AntiNukerA module`,
        `    -e, --enable    Enable AntiNukerA module`,
        `    -d, --disable   Disable AntiNukerA module`,
        `§4[§6Description§4]§f: Checks players for nuking blocks.`,
        `§4[§6Examples§4]§f:`,
