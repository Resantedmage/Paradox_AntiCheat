...
function antiscaffoldaHelp(player: Player, prefix: string, antiScaffoldABoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `§4[§6Usage§4]§f: antiscaffolda [options]`,
        `§4[§6Options§4]§f:`,
        `    -h, --help      Display this help message`,
        `    -s, --status    Display the current status of AntiScaffoldA module`,
        `    -e, --enable    Enable AntiScaffoldA module`,
        `    -d, --disable   Disable AntiScaffoldA module`,
