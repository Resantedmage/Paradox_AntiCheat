...
function chatRanksHelp(player: Player, prefix: string, chatRanksBoolean: boolean, setting: boolean): void {
    ...
    sendMsgToPlayer(player, [
        ...
        `§4[§6Usage§4]§f: chatranks [options]`,
        `§4[§6Options§4]§f:`,
        `    -h, --help      Display this help message`,
        `    -s, --status    Display the current status of ChatRanks module`,
        `    -e, --enable    Enable ChatRanks module`,
        `    -d, --disable   Disable ChatRanks module`,
